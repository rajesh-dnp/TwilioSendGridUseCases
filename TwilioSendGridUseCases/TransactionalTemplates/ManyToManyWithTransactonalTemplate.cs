...
{
    public static class ManyToManyWithTransactonalTemplate
    {
        public static async void SendEmail()
        {
            ...
            var msg = CreateMultipleEmailsToMultipleRecipients(from, tos, templateId, userData);
